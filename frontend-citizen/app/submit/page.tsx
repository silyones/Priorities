...
> = {
  english: {
    ...
    phoneNumberPlaceholder: "e.g. 99999XXXXX",
  ...
  hindi: {
    ...
    phoneNumberPlaceholder: "जैसे 99999XXXXX",
  ...
  kannada: {
    ...
    phoneNumberPlaceholder: "ಉದಾ. 99999XXXXX",
  ...
  tamil: {
    ...
    phoneNumberPlaceholder: "எ.கா. 99999XXXXX",
  ...
  telugu: {
    ...
    phoneNumberPlaceholder: "ఉదా. 99999XXXXX",
  ...
  bengali: {
    ...
    phoneNumberPlaceholder: "যেমন 99999XXXXX",
