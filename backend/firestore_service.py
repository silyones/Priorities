"""Firestore access — REST on Railway, TypeScript bridge locally."""
...
_USE_REST = os.getenv("FIRESTORE_USE_REST", "auto").lower()
...
if _use_rest():
    from firestore_rest import (  # noqa: F401
        ...
        list_submissions,
        list_submissions_internal,
        list_themes_source_data,
        migrate_create_issue,
        save_submission,
        update_issue_status,
    )
else:
